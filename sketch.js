...
function setup() {
    ...
    download_button = new Button(0.825 * width, 0.6 * height, 0.15 * width, 0.1 * height, "Download coefficients", color(128), color(96));
